...
golem::fill_desc(
  pkg_name = "OCMSExplorer", # The Name of the package containing the App 
  pkg_title = "OCMSExplorer", # The Title of the package containing the App 
  pkg_description = "Shiny app to browse and explore 16S rRNA data analyzed by OCMS", # The Description of the package containing the App 
  author_first_name = "Sandi", # Your First Name
  author_last_name = "Yen",  # Your Last Name
  author_email = "sandi.yen@kennedy.ox.ac.uk",      # Your Email
