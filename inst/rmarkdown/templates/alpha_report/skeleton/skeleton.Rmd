...
```{r, eval=params$asv_select_prompt == 'some' & params$asv_filter_options == 'asv_by_count', fig.cap="Distribution of feature prevalence based on read count. Each point is feature of a sample, with y-axis as the read count and x-axis as the number of samples in which a given feature is observed."}
...
```{r, eval = params$asv_select_prompt == 'some' & params$asv_filter_options == 'asv_by_select'}
out <- params$tax1 %>% 
