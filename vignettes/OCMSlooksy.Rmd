...
OCMSlooksy is an R package that contains the app and several helper functions that help prepare input files required for the app. The OCMSlooksy R package can be installed from the [OCMS github](https://github.com/OxfordCMS/OCMSlooksy).
...
![Figure 2A. Interactive plots](screenshots/interactiveplots.png)
...
* "Image (png)" downloads the static figure as a .png file. Note this defaults to 5in x 7in so large figures may looked squished
* "Image (pdf)" downloads the static figure as a .pdf file.
...
* "All" downloads "Image (png)," "Image (pdf)," "Interactive Plot," and "Plot data"in a .zip file.
...
![Figure 3. Saving and interacting with tables](screenshots/savetable.png){width=100%}
...
![Figure 4A. Import Data](screenshots/import1.png){width=100%}
...
![Figure 4B. Import Data](screenshots/import2.png){width=100%}
...
![Figure 5. QC report](screenshots/QCreport.png){width=100%}
...
![Figure 6A. Aggregate counts](screenshots/aggregatefeat1.png){width=100%}
...
![Figure 6B. Updated taxonomy table](screenshots/aggregatefeat2.png){width=100%}
...
![Figure 7. Filter features](screenshots/filterfeature1.png){width=100%}
...
![Figure 8A. Filter features](screenshots/filterfeature2.png){width=100%}
...
![Figure 8B. Evaluting effectiveness of filter.](screenshots/filterfeature3.png){width=100%}
![Figure 8C. Preview filtered features](screenshots/filterfeature4.png){width=100%}
...
![Figure 9. Filter features by selection](screenshots/filterfeature5.png){width=100%}
...
![Figure 10A. Microbiome profile analysis](screenshots/microbiomeprofile1.png){width=100%}
...
![Figure 10B. Microbiome profile parameters](screenshots/microbiomeprofile2.png){width=100%}

Applying changes will update an abundance table and show interactive plot of the microbiome profiles.

![Figure 11A. Abundance table](screenshots/microbiomeprofile3.png){width=100%}
![Figure 11B. Microbiome profile plot](screenshots/microbiomeprofile4.png){width=100%}
...
![Figure 15B. Comparing within-group sample dissimilarity across treatment groups, for different genotypes, with statistical testing. Calculated at the genus level.](screenshots/sampledissimilarity2.png){width=100%}
